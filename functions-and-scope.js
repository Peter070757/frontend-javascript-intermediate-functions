...
const avgFinalGrade = sumOfGrades / grades.length;

console.log(avgFinalGrade);
...
console.log(avgGrade([6, 4, 5]));
console.log(avgGrade([8, 9, 4, 6, 10]));
...
let highestFinalGrade = 0;

for (let i = 0; i < grades.length; i++) {
    if (grades[i] > highestFinalGrade) {
        highestFinalGrade = grades[i];
    }
}

console.log(highestFinalGrade);
